...
const FixedProductMarketMakerFactory = getContract('FixedProductMarketMakerFactory');
...
const subgraphName = 'openpredict/openmarket';
...
describe('OpenMarket subgraph', function() {
